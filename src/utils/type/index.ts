...
export type DObject = DPointer|DNamed|DLobby|DUser|DGame|DPlayer|DCard|DGameCard|DDeck|DGameDeck|DGameHand;
export type LObject = LPointer|LNamed|LLobby|LUser|LGame|LPlayer|LCard|LGameCard|LDeck|LGameDeck|LGameHand;
